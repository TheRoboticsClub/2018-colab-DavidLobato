...
case class SB_SPRAM256KA() extends BlackBox {
  ...
  addRTLPath("src/main/resources/blackbox/lattice/ice40/SB_SPRAM256KA.v") //verilator mockup
  addRTLPath("src/main/resources/blackbox/lattice/ice40/SPRAM256KA.v") //from radiant cae library. I can't distribute this file.
}
